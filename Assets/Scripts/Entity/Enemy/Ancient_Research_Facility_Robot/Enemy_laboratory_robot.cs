...
public class Enemy_laboratory_robot : Entity
{

    public Enemy_laboratory_robot_IdleState IdleState;
    public Enemy_laboratory_robot_MoveState MoveState;
    public Enemy_laboratory_robot_BattleState BattleState;
    public Enemy_laboratory_robot_JumpState JumpState;
    public Enemy_laboratory_robot_AttackState AttackState;
    public Enemy_laboratory_robot_GroggyState  GroggyState;
    private Enemy_laboratory_robot_DeadState DeadState;
    ...
    protected virtual void Awake()
    {
        ...
        EnemyStateMachine = new Enemy_laboratory_robot_StateMachine();
        coll = GetComponent<BoxCollider2D>();
        stats = GetComponent <Enemy_Stats>();

        AttackState = new Enemy_laboratory_robot_AttackState(this, EnemyStateMachine, "attack");
        IdleState = new Enemy_laboratory_robot_IdleState(this, EnemyStateMachine, "idle");
        MoveState = new Enemy_laboratory_robot_MoveState(this, EnemyStateMachine, "move");
        BattleState = new Enemy_laboratory_robot_BattleState(this, EnemyStateMachine, "battle");
        // GroundedState = new Enemy_GroundedState(this, EnemyStateMachine,null);
        JumpState = new Enemy_laboratory_robot_JumpState(this, EnemyStateMachine, "jump", jumpData);
        GroggyState = new Enemy_laboratory_robot_GroggyState(this,EnemyStateMachine, "groggy");
        DeadState = new Enemy_laboratory_robot_DeadState(this,EnemyStateMachine, "dead",coll);
