...
public class Enemy_Spine : Entity
{

    public Enemy_Spine_IdleState IdleState;
    public Enemy_Spine_MoveState MoveState;
    public Enemy_Spine_BattleState BattleState;
    public Enemy_Spine_JumpState JumpState;
    public Enemy_Spine_AttackState AttackState;
    public Enemy_Spine_GroggyState  GroggyState;
    private Enemy_Spine_DeadState DeadState;
    ...
    protected virtual void Awake()
    {
        ...
        EnemyStateMachine = new Enemy_Spine_StateMachine();
        coll = GetComponent<BoxCollider2D>();
        stats = GetComponent <Enemy_Stats>();

        AttackState = new Enemy_Spine_AttackState(this, EnemyStateMachine, "attack");
        IdleState = new Enemy_Spine_IdleState(this, EnemyStateMachine, "idle");
        MoveState = new Enemy_Spine_MoveState(this, EnemyStateMachine, "move");
        BattleState = new Enemy_Spine_BattleState(this, EnemyStateMachine, "battle");
        // GroundedState = new Enemy_GroundedState(this, EnemyStateMachine,null);
        JumpState = new Enemy_Spine_JumpState(this, EnemyStateMachine, "jump", jumpData);
        GroggyState = new Enemy_Spine_GroggyState(this,EnemyStateMachine, "groggy");
        DeadState = new Enemy_Spine_DeadState(this,EnemyStateMachine, "dead");
