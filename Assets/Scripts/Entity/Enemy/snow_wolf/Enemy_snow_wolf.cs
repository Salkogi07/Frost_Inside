...
public class Enemy_snow_wolf : Entity
{

    public Enemy_snow_wolf_IdleState IdleState;
    public Enemy_snow_wolf_MoveState MoveState;
    public Enemy_snow_wolf_BattleState BattleState;
    public Enemy_snow_wolf_JumpState JumpState;
    public Enemy_snow_wolf_AttackState AttackState;
    public Enemy_snow_wolf_GroggyState  GroggyState;
    private Enemy_snow_wolf_DeadState DeadState;
    ...
    protected virtual void Awake()
    {
        ...
        EnemyStateMachine = new Enemy_snow_wolf_StateMachine();
        coll = GetComponent<BoxCollider2D>();
        stats = GetComponent <Enemy_Stats>();

        AttackState = new Enemy_snow_wolf_AttackState(this, EnemyStateMachine, "attack");
        IdleState = new Enemy_snow_wolf_IdleState(this, EnemyStateMachine, "idle");
        MoveState = new Enemy_snow_wolf_MoveState(this, EnemyStateMachine, "move");
