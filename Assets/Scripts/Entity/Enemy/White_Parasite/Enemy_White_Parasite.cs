...
public class Enemy_White_Parasite : Entity
{

    public Enemy_White_Parasite_IdleState IdleState;
    public Enemy_White_Parasite_MoveState MoveState;
    ...
    protected virtual void Awake()
    {
        ...
        EnemyStateMachine = new Enemy_White_Parasite_StateMachine();
        coll = GetComponent<BoxCollider2D>();
        stats = GetComponent <Enemy_Stats>();

        AttackState = new Enemy_White_Parasite_AttackState(this, EnemyStateMachine, "attack");
        IdleState = new Enemy_White_Parasite_IdleState(this, EnemyStateMachine, "idle");
        MoveState = new Enemy_White_Parasite_MoveState(this, EnemyStateMachine, "move");
        BattleState = new Enemy_White_Parasite_BattleState(this, EnemyStateMachine, "battle");
        // GroundedState = new Enemy_GroundedState(this, EnemyStateMachine,null);
        JumpState = new Enemy_White_Parasite_JumpState(this, EnemyStateMachine, "jump", jumpData);
        DeadState = new Enemy_White_Parasite_DeadState(this,EnemyStateMachine, "dead");
