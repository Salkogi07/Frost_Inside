...
public class Enemy_Skeleton_JumpState : EnemyState
{
    public EnemyJumpData _jumpData;
    public string StateName;
    private Vector2 originalGroundCheckLocalPos;
    public Enemy_Skeleton_JumpState(Enemy_StateMachine enemyStateMachine, string animBoolName,EnemyJumpData JumpData) : base(null, enemyStateMachine, animBoolName)
    {
        _jumpData =  JumpData;
    }
